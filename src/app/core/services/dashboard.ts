...
const ALL_AVAILABLE_WIDGETS: Omit<DashboardWidget, 'x' | 'y'>[] = [
  ...
  { id: 'kpi-roe', componentType: 'kpi-roe', name: 'KPI: ROE', cols: 1, rows: 2, data: { title: 'ROE (Retorno s/ Patrimonio)', value: '15.2%', comparisonValue: '+1.2%', comparisonPeriod: 'vs Año Anterior', isPositive: true } as Kpi },
  { id: 'kpi-roa', componentType: 'kpi-roa', name: 'KPI: ROA', cols: 1, rows: 2, data: { title: 'ROA (Retorno s/ Activos)', value: '8.1%', comparisonValue: '+0.5%', comparisonPeriod: 'vs Año Anterior', isPositive: true } as Kpi },
  { id: 'kpi-current-ratio', componentType: 'kpi-current-ratio', name: 'KPI: Liquidez Corriente', cols: 1, rows: 2, data: { title: 'Liquidez Corriente', value: '2.1', comparisonValue: '-0.1', comparisonPeriod: 'vs Mes Anterior', isPositive: false } as Kpi },
  { id: 'kpi-quick-ratio', componentType: 'kpi-quick-ratio', name: 'KPI: Prueba Ácida', cols: 1, rows: 2, data: { title: 'Prueba Ácida', value: '1.2', comparisonValue: '+0.2', comparisonPeriod: 'vs Mes Anterior', isPositive: true } as Kpi },
  { id: 'kpi-working-capital', componentType: 'kpi-working-capital', name: 'KPI: Capital de Trabajo', cols: 1, rows: 2, data: { title: 'Capital de Trabajo', value: '$250.8K', comparisonValue: '', comparisonPeriod: 'Actual', isPositive: true } as Kpi },
...
const EXECUTIVE_LAYOUT: DashboardWidget[] = [
  ...
  { id: 'kpi-roe', componentType: 'kpi-roe', x: 0, y: 0, cols: 1, rows: 2, name: 'KPI: ROE', data: { title: 'ROE (Retorno s/ Patrimonio)', value: '15.2%', comparisonValue: '+1.2%', comparisonPeriod: 'vs Año Anterior', isPositive: true } as Kpi },
  { id: 'kpi-roa', componentType: 'kpi-roa', x: 1, y: 0, cols: 1, rows: 2, name: 'KPI: ROA', data: { title: 'ROA (Retorno s/ Activos)', value: '8.1%', comparisonValue: '+0.5%', comparisonPeriod: 'vs Año Anterior', isPositive: true } as Kpi },
  { id: 'kpi-current-ratio', componentType: 'kpi-current-ratio', x: 2, y: 0, cols: 1, rows: 2, name: 'KPI: Liquidez Corriente', data: { title: 'Liquidez Corriente', value: '2.1', comparisonValue: '-0.1', comparisonPeriod: 'vs Mes Anterior', isPositive: false } as Kpi },
  { id: 'kpi-quick-ratio', componentType: 'kpi-quick-ratio', x: 3, y: 0, cols: 1, rows: 2, name: 'KPI: Prueba Ácida', data: { title: 'Prueba Ácida', value: '1.2', comparisonValue: '+0.2', comparisonPeriod: 'vs Mes Anterior', isPositive: true } as Kpi },
];
